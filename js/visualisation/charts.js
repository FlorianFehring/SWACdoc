...
charts_example7_options.plugins.set('Barchart', {
    id: 'Barchart',
    active: true
});
...
// Example 8
charts_example8_options = {
    showWhenNoData: true,
    xAxisAttrName: 'time',
    yAxisAttrNames: ['temp'],
    plugins: new Map()
};
charts_example8_options.plugins.set('Linechart', {
    id: 'Linechart',
    active: true
});

document.addEventListener('uiComplete', function () {
    let clrBtn = document.querySelector('.charts_example8_clr');
    clrBtn.addEventListener('click', function () {
        document.querySelector('#charts_example8').swac_comp.removeAllData();
    });

    let addnewBtn = document.querySelector('.charts_example8_addnew');
    addnewBtn.addEventListener('click', function () {
        let req = document.getElementById('charts_example8');
        req.swac_comp.addDataFromReference("ref://../../data/visualisation/charts/example7_series2.json");
    });

    let adddiffBtn = document.querySelector('.charts_example8_adddiff');
    adddiffBtn.addEventListener('click', function () {
        let req = document.getElementById('charts_example8');
        req.swac_comp.addDataFromReference("ref://../../data/visualisation/charts/example8_series3.json");
    });
});
